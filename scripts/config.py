#!/usr/bin/env python3
"""
Guomics PPT - Unified Configuration Management Module
(Extended from PPT Master with Guomics branding)
...
# ============================================================
# Guomics Branding Configuration
# ============================================================

# Absolute path to the Guomics branded PPTX template
GUOMICS_TEMPLATE_PATH = "/home/lazarus/westlake/guomics_ppt/Guomics ppt_template.pptx"

# Default canvas format for all Guomics presentations
GUOMICS_DEFAULT_FORMAT = "ppt169"

# Guomics color palette (extracted from Guomics ppt_template.pptx)
GUOMICS_COLORS = {
    'primary': '#004791',       # Deep navy — title backgrounds, key headers
    'accent': '#F18D00',        # Orange/gold — highlights, callouts, emphasis
    'text_dark': '#212121',     # Near-black — body text
    'text_light': '#FFFFFF',    # White — text on dark backgrounds
    'background': '#FFFFFF',    # White — slide backgrounds
    'background_alt': '#F5F7FA' # Light gray — section backgrounds
}

# Guomics font sizes (in points, from template analysis)
GUOMICS_FONT_SIZES = {
    'title_large': 80,      # Closing slide "Thanks!"
    'title': 48,            # Main presentation title
    'section': 40,          # Summary, major sections
    'heading': 36,          # Outline, slide headings
    'subtitle': 26,         # Slide subtitles / section labels
    'author': 24,           # Author name
    'body_large': 20,       # Summary bullet points
    'body': 18,             # Standard content text
    'institution': 16,      # Affiliation / institution
    'caption': 14,          # Figure captions, labels
    'small': 11,            # Citations, footnotes, URLs
}

# Guomics fonts (from template)
GUOMICS_FONTS = {
    'heading': 'Arial Black',
    'body': 'Arial',
}
